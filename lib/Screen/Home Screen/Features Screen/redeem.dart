                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(isBalanceShow ? info.data?.user?.wallet?.balance.toString() ?? '0' : 'Balance'),
                      const SizedBox(width: 5.0),
                      AnimatedOpacity(
                        opacity: isBalanceShow ? 1.0 : 0.0,
                        duration: const Duration(milliseconds: 1000),
                      ...
                      return HorizontalList(
                          ...
                          itemBuilder: (_, i) {
                            return Stack(
                              ...
                              setState(() {
                                methodId = info.data!.withdrawMethod![i].id!;
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text('${currency.data?.currencyConvertInfo?[index].currency?.symbol ?? ''} ${currency.data?.currencyConvertInfo?[index].currency?.isoCode ?? ''} (${currency.data?.currencyConvertInfo?[index].currency?.name ?? ''})'),
                                      const SizedBox(
                                        width: 4.0,
                                      ),
                                      const Icon(
                                  ...
                                  setState(() {
                                    currencyId = currency.data?.currencyConvertInfo?[index].id ?? 0;
                                  });
                                }),
                                const SizedBox(height: 4.0,),
                                Text('${currency.data?.currencyConvertInfo?[index].parCurrency ?? ''} ${currency.data?.currencyConvertInfo?[index].currency?.isoCode ?? ''} = ${currency.data?.currencyConvertInfo?[index].coin ?? ''} coins').visible(currencyId == currency.data!.currencyConvertInfo![index].id!)
                              ],
                            );
                          });
                    }, error: (e, stack) {
                    ...
                    ButtonGlobal(
                      ...
                      onPressed: (() async {
                        try{
                          ...
                          } else if(methodId == 0 && currencyId == 0){
                            EasyLoading.showError('Please Select Withdraw Method and Currency');
                          } else if(info.data!.user!.wallet!.balance! < coinsController.text.toInt()){
                            EasyLoading.showError('Not Enough Balance');
                          } else {
