...
import 'package:zilli/Provider/og_ads_provider.dart';
import 'package:zilli/Screen/Og%20Ads/ogads_offer_details.dart';
...
class OgAdsOfferWall extends StatefulWidget {
  const OgAdsOfferWall({Key? key}) : super(key: key);
                        ...
                        itemBuilder: (_, i) {
                          return Card(
                            ...
                            child: Container(
                              ...
                              OgAdsOfferDetails(ogAdsOfferWall: offer.offers![i]).launch(context));
                        })
                  ],
                ),
              ),
