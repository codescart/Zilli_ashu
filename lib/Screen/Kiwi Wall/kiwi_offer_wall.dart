...
import 'package:zilli/Provider/kiwi_wall_provider.dart';
import 'package:zilli/Screen/Kiwi%20Wall/kiwi_offer_details.dart';
...
class KiwiOfferWall extends StatefulWidget {
  const KiwiOfferWall({Key? key}) : super(key: key);
                        ...
                        itemBuilder: (_, i) {
                          return Card(
                            ...
                            child: Container(
                              ...
                              KiwiOfferDetails(kiwiOfferWall: offer.offers![i],).launch(context));
                        })
                  ],
                ),
              ),
